#!/usr/bin/env python3
"""Deploy agent dialer fixes: disposition, connect, stop, expand/pick lead."""
...
def main() -> int:
    ...
    try:
        ...
        out = sudo_run(
            ...
            f"""
cd {REMOTE_APP}
npm run build > /tmp/vite-agent-dialer-fix.log 2>&1
tail -n 18 /tmp/vite-agent-dialer-fix.log
echo BUILD:$?
chown -R www-data:www-data {REMOTE_APP}/public/build
php artisan view:clear >/dev/null 2>&1 || true
php artisan optimize:clear >/dev/null 2>&1 || true
grep -n "autoDialSessionGeneration\\|stillAuto\\|My lead sheets\\|skipCooldown\\|ch-dial-auto-session\\|fileOptions(\\$workspace, (int)" \\
  resources/js/communications-auto-dial.js \\
  resources/js/communications-dialer.js \\
  resources/views/communications/partials/center-dialer-hub.blade.php \\
  app/Http/Controllers/CommunicationsHubController.php \\
  resources/css/comm-hub-ghl-theme.css | head -35
""",
            check=False,
        )
        print(out)
