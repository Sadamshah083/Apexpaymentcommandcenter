#!/usr/bin/env python3
"""Deploy Find recording fixes + hide technical talk statuses; backfill missing recordings."""
...
echo "scanned={$logs->count()} ready={$ready} still_pending={$pending}\n";
"""
...
def main() -> int:
    ...
    ssh.close()
    print("Find recording + talk-status fix deployed.")
    return 0
