#!/usr/bin/env python3
"""Deploy Assigned Leads sticky header + screen-height scroll table."""
...
def main() -> int:
    ...
    buf.seek(0)
    remote_tar = "/tmp/apexone-assigned-scroll.tar.gz"
    sftp = ssh.open_sftp()
...
print('assigned_class', 'import-workflows-page--assigned' in idx)
print('table_class', 'assigned-leads-data-table' in panel)
print('sticky_css', 'Assigned Leads' in css and 'position: sticky' in css)
PY
echo DONE
"""
