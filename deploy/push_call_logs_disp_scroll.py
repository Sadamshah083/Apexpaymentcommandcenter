#!/usr/bin/env python3
"""Deploy: hide completed/initiated from call-log Status + viewport scroll table."""
...
grep -n "resolveDisplayDisposition\\|table-wrap--viewport\\|r2:" \\
  app/Services/Communications/AgentStatusReportService.php \\
  resources/views/communications/agent-status/partials/panel.blade.php \\
  resources/css/app.css | head -20
echo DONE_CALL_LOGS_DISP_SCROLL
"""
