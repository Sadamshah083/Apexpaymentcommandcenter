...
# New bundle hash + confirm optimistic path markers
ls -1 public/build/assets/communications-*.js | tail -3
grep -n "buildOptimisticDispositionPayload\\|Instant close — never wait\\|No AbortController — never cancel" \\
  resources/js/communications-auto-dial.js \\
  resources/js/communications-webphone.js | head -20
echo DONE_DISPOSITION_OPTIMISTIC
"""
