...
grep -n "import-disposition-cards\\|agent-status-disposition-cards\\|disposition_choice\\|availableDispositionLabels" \\
  resources/views/admin/dashboard/partials/imports-panel.blade.php \\
  resources/views/communications/agent-status/partials/panel.blade.php \\
  app/Services/Communications/AgentStatusReportService.php \\
  app/Http/Controllers/AgentStatusReportController.php | head -40
echo DONE_DISPOSITION_SUMMARY_UI
"""
