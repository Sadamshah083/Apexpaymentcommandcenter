#!/usr/bin/env python3
"""Deploy stacked User column (name up, role badge down)."""
...
REMOTE = r"""
cd /var/www/apexone
npm run build > /tmp/vite-user-stack.log 2>&1
echo BUILD:$?
tail -n 8 /tmp/vite-user-stack.log
...
print(css.name)
print('flex-direction:column', t.count('flex-direction:column'))
...
def main() -> int:
    ...
    ssh.close()
    print("User stack deployed. Hard refresh Ctrl+Shift+R.")
    return 0
