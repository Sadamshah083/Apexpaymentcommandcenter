...
return [
    ...
    'morpheus' => [
        ...
        'turn_urls' => env('MORPHEUS_TURN_URLS', ''),
        'turn_username' => env('MORPHEUS_TURN_USERNAME', ''),
        'turn_credential' => env('MORPHEUS_TURN_CREDENTIAL', ''),
    ...
    'communications' => [
        ...
        // Place-call / click-to-call should outlast brief Morpheus SSL or upstream stalls.
        'originate_http_timeout_seconds' => (int) env('COMMUNICATIONS_ORIGINATE_HTTP_TIMEOUT', 15),
