...
<div class="app-page space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        @foreach($teamMetrics as $metric)
            ...
            @endphp
            <a href="{{ route('portal.setter-team.dashboard', array_filter(['setter' => $metric['user']->id, 'search' => request('search')])) }}"
    ...
    <div class="app-card app-card-padded">
        <form method="GET" action="{{ route('portal.setter-team.dashboard') }}" class="flex flex-wrap items-end gap-3 mb-4">
            ...
            @if(request()->filled('search') || request()->filled('setter'))
