...
@section('content')
    <div class="app-page space-y-6">
        <div>
            ...
            <p class="app-page-subtitle">Revisit old leads, no-shows, lost opportunities, and expired proposals —
                        ...
                        <tbody id="workspace-sync-reactivation-body">
                            @foreach ($candidates as $lead)
                                <tr data-lead-id="{{ $lead->id }}">
                                    ...
                                    <td>
                                        <form method="POST" action="{{ route('admin.sales-ops.reactivate', $lead->id) }}"
                                            ...
                                            <button type="submit"
                                                class="app-btn app-btn-primary app-btn-sm">Enroll</button>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
