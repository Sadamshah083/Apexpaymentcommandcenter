...
@section('content')
    <div class="app-page space-y-6">
        <div>
            ...
            <p class="app-page-subtitle">Meetings scheduled, proposals sent, and deals in follow-up — qualified opportunities
                only.</p>
        </div>
                ...
                <tbody id="workspace-sync-ae-pipeline-body">
                    @foreach ($leads as $lead)
                        <tr data-lead-id="{{ $lead->id }}">
                            ...
                            <td>{{ $lead->monthly_processing_volume ? '$' . number_format($lead->monthly_processing_volume) : '—' }}
                            </td>
