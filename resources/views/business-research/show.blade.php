        ...
        @if ($research->status === 'failed')
            <div class="app-alert app-alert-danger">
                ...
                @if (str_contains($research->error_message ?? '', 'Gemini'))
                    <p class="app-alert-desc mt-2">Confirm <code
                            class="text-xs bg-rose-100 px-1 rounded">GEMINI_API_KEY</code> in <code
                            class="text-xs bg-rose-100 px-1 rounded">.env</code> is from <a
                            href="https://aistudio.google.com/apikey" target="_blank" rel="noopener" class="app-link">Google
                            AI Studio</a>.</p>
                @endif
        ...
        @if ($research->status === 'completed')
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="app-card app-card-padded">
                    ...
                    <p class="text-sm font-semibold text-zinc-900 mt-1 break-all">
            ...
            <details class="app-details app-card app-card-padded">
                ...
                @if ($research->model_used)
                    <p class="text-xs text-zinc-400 mt-2">Model: {{ $research->model_used }} · Tokens:
