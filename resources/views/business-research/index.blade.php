...
@section('content')
    <div class="app-page space-y-6">
        <x-page-header title="Merchant Research"
                ...
                <form action="{{ route('admin.business-research.store') }}" method="POST" class="space-y-4">
                    ...
                    <div class="app-field">
                        ...
                        <input type="text" name="business_name" value="{{ old('business_name') }}" required
                            placeholder="e.g. bluefrog Plumbing and Drain" class="app-input">
                    </div>
                    <div class="app-field">
        ...
        <x-data-table title="Recent research" :paginator="$researches">
            <table>
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center py-8 text-zinc-400">No research yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
