        ...
        <div class="ghl-settings">
            ...
            <div class="comm-hub-card p-6 space-y-4 mt-6">
                ...
                <p class="text-sm text-slate-500">
                    ...
                    Recordings, voicemails, SMS, and team chat are not exposed by this API — those hub tabs show empty
                    states.
                </p>
                <ul class="text-sm text-slate-600 space-y-2 list-disc pl-5">
                    <li><code class="text-xs">calls:read</code> / <code class="text-xs">calls:control</code> — list,
                        transfer, hangup, hold, park, bridge, disposition</li>
                    ...
                    <li><code class="text-xs">leads:*</code> / <code class="text-xs">campaigns:*</code> / <code
                            class="text-xs">lists:*</code> — dialer CRM</li>
                    <li><code class="text-xs">users:*</code> / <code class="text-xs">extensions:*</code> — agents &amp; SIP
                        lines</li>
                </ul>
            </div>
        </div>
