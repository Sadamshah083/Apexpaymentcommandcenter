...
<form method="POST"
    ...
    <input type="tel"
           id="dial-number-rail"
           name="destination"
           class="comm-hub-input w-full mb-2 comm-hub-input-sm ghl-dialer-display"
           value="{{ $prefillNumber ?? '' }}"
    ...
    <button type="submit" id="morpheus-dial-btn-rail" class="comm-hub-btn ghl-call-btn w-full text-center">Call</button>
</form>
