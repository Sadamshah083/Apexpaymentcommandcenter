<div class="ghl-settings ghl-inbox-settings">
    ...
    <div class="comm-hub-card p-6 space-y-4 mt-6">
        ...
        <div class="comm-hub-field"><span class="comm-hub-label">Morpheus Host</span><code class="comm-hub-code">{{ $settings['accountId'] ?? '—' }}</code></div>
        <div class="comm-hub-field"><span class="comm-hub-label">Morpheus API Key</span><code class="comm-hub-code">{{ $settings['maskedSecret'] ?? '—' }}</code></div>
    </div>
</div>
