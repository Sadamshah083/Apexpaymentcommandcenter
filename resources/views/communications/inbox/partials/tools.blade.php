        ...
        @if(!empty($callStats))
            <div>
                ...
                <div class="ghl-inbox-rail-stats">
                    ...
                    <div><span class="ghl-inbox-rail-stat-value">{{ $callStats['inbound'] ?? 0 }}</span><span class="ghl-inbox-rail-stat-label">Inbound</span></div>
                    <div><span class="ghl-inbox-rail-stat-value">{{ $callStats['outbound'] ?? 0 }}</span><span class="ghl-inbox-rail-stat-label">Outbound</span></div>
