...
<aside class="ghl-inbox-tools ghl-comm-dial-rail">
    <div class="ghl-comm-dial-rail__pad">
        <div class="ghl-comm-dial-rail__keypad">
            <p class="ghl-comm-dial-rail__label">Dial</p>
            @include('communications.partials.dialer-form', [
                ...
                'backspaceId' => 'dial-backspace-rail',
                ...
                'layout' => 'right-rail',
                'hideExtension' => true,
                'formId' => 'dial-caller-id-rail-form',
            ])
        </div>
    </div>

    <details class="ghl-comm-dial-rail__details" open>
        <summary class="ghl-comm-dial-rail__details-toggle">Contact details</summary>
            ...
            @if (!empty($callLogs))
                <section class="ghl-tools-section ghl-tools-section-card ghl-tools-call-feed">
                    ...
                    <div class="ghl-tools-call-feed-list">
                        @foreach (collect($callLogs)->take(6) as $log)
                            @php
