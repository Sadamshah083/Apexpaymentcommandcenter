...
@section('content')
    <div class="ghl-hub">
        @include('communications.partials.hub-tabs', [
            'mode' => 'recordings',
        ...
        <div class="ghl-call-feed">
            ...
            @empty
                <div class="ghl-empty py-16">No recordings in this date range. Add cloud recording scopes in Settings if you
                    expect meeting recordings.</div>
            @endforelse
        </div>
