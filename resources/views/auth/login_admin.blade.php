...
<head>
    ...
    <style>
        ...
        .input-glass:focus {
            background: #ffffff;
            border-color: #000000; /* warmgrey-500 */
...
<body class="flex items-center justify-center p-4 md:p-8">
    <div class="w-full max-w-md space-y-6">
        ...
        <div class="text-center space-y-2">
            ...
            <p class="text-warmgrey-500 text-sm">Admin workspace</p>
        </div>
        ...
        <div class="glass-card rounded-3xl p-8 md:p-10 transition-all duration-300">
            <div class="space-y-6">
                <div>
                    <h2 class="text-2xl font-bold tracking-tight text-warmgrey-900">Admin Login</h2>
                    <p class="text-warmgrey-500 text-xs mt-1">Workspace owner sign-in. Admins can also access the agent portal with the same credentials.</p>
                </div>
                ...
                <form method="POST"
                      ...
                      data-loading-message="Verifying your admin credentials…"
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="username" required placeholder="e.g. admin_user" value="{{ old('username') }}" class="w-full px-4 py-3 rounded-xl input-glass text-sm">
                    </div>
