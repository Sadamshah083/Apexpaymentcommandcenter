        ...
        <div class="glass-card rounded-3xl p-8 md:p-10 transition-all duration-300">
            <div class="space-y-6">
                <div>
                    ...
                    <p class="text-warmgrey-500 text-xs mt-1">Workspace owner sign-in. Admins can also access the agent
                ...
                <form method="POST" action="{{ route('admin.login') }}" class="space-y-4" data-admin-login data-form-loading
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="username" required placeholder="e.g. admin_user"
                ...
                <div class="pt-4 border-t border-warmgrey-100 text-center">
                    <p class="text-xs text-warmgrey-500">
                        ...
                        <a href="{{ route('admin.register-workspace') }}"
                            class="text-warmgrey-900 hover:underline font-semibold transition-colors">Create one
                            here</a>
                    </p>
                </div>
            </div>
