<x-sidebar.section title="Pipeline">
    ...
    @if ($role === 'appointment_setter')
        ...
        <x-sidebar.link :href="route('portal.performance')" label="Performance" :active="request()->routeIs('portal.performance')">
    ...
    @elseif($role === 'closers_team_lead')
        <x-sidebar.link :href="route('portal.closer-team.dashboard')" label="Closer Team" :active="request()->routeIs('portal.closer-team.*')">
            <x-slot:icon>@include('layouts.partials.sidebar-icon', ['name' => 'team'])</x-slot:icon>
        </x-sidebar.link>
    ...
    @elseif($role === 'closer')
        ...
        <x-sidebar.link :href="route('portal.pipeline')" label="Pipeline" :active="request()->routeIs('portal.pipeline')">
            <x-slot:icon>@include('layouts.partials.sidebar-icon', ['name' => 'pipeline'])</x-slot:icon>
        </x-sidebar.link>
    @endif
</x-sidebar.section>
...
<x-sidebar.section title="Communications">
    <x-sidebar.link :href="route('portal.communications.index')" label="Communications"
