...
<div class="app-page max-w-xl mx-auto space-y-6">
    <div>
        ...
        <p class="app-page-subtitle">Upload a spreadsheet. Map columns, tag your list, then import ΓÇö enrichment and distribution are optional later steps.</p>
    </div>
    ...
    <div class="app-card app-card-padded">
        <form method="POST"
              ...
              data-loading-message="Reading your spreadsheet and mapping columnsΓÇª"
              data-loading-button-text="UploadingΓÇª">
            @csrf
            <input type="hidden" name="processing_mode" value="import_only">

            <div class="app-field">
                <label for="name" class="app-label">List name</label>
                <input type="text" name="name" id="name" required placeholder="e.g. Houston salons ΓÇö June 2026" class="app-input">
