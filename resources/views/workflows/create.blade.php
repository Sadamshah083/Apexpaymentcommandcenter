...
@section('content')
    <div class="app-page max-w-xl mx-auto space-y-6">
        <div>
            ...
            <p class="app-page-subtitle">Upload a spreadsheet. Map columns, tag your list, then import — enrichment and
                distribution are optional later steps.</p>
        </div>

        <div class="app-card app-card-padded">
            <form method="POST" action="{{ route('admin.workflows.store') }}" enctype="multipart/form-data" class="space-y-5"
                data-form-loading data-loading-title="Uploading file"
                data-loading-message="Reading your spreadsheet and mapping columns…" data-loading-button-text="Uploading…">
                @csrf
                ...
                <div class="app-field">
                    ...
                    <input type="text" name="name" id="name" required
                        placeholder="e.g. Houston salons — June 2026" class="app-input">
                ...
                <div class="app-field">
                    ...
                    <div class="app-upload-zone">
                        ...
                        <div id="upload-placeholder" class="space-y-2">
                            ...
                            <p class="text-xs text-zinc-400">Up to 10 MB · US phone numbers normalized to +1 (XXX) XXX-XXXX
                            </p>
                        </div>
