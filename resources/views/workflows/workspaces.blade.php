...
@section('content')
    ...
    <div id="workspace-member-management" class="um-page" data-workspace-id="{{ $activeWorkspace->id }}"
                ...
                <section class="um-panel" id="workspace-active-context">
                    <div class="um-panel-header">
                        ...
                        <p class="um-panel-meta">
                            ...
                            <span id="workspace-active-owner-email"
                                class="um-text-muted">({{ $activeWorkspace->admin->email }})</span>
                        </p>
                    </div>
                </section>
                ...
                <section class="um-panel um-panel-compact">
                    ...
                    <div class="um-portal-links">
                        ...
                        <div class="um-portal-link">
                            ...
                            <span class="um-portal-link-hint">Setters &amp; closers (use <strong>username</strong>, not
                                email)</span>
                        </div>
                    </div>
                </section>
                ...
                <section class="um-panel um-panel-flush">
                    <div class="um-panel-toolbar">
                        <div>
                            ...
                            <p class="um-panel-desc">Suspend, change roles, reset passwords, or limit admin module access.
                            </p>
                        </div>
                    ...
                    <div id="workspace-sync-team" class="member-team-list um-member-list" data-admin-team="1">
                    ...
                    @if (auth()->user()->canManageWorkspaceMembers($activeWorkspace->id))
                        <div class="um-add-member">
                            ...
                            <p class="um-panel-desc mb-4">
                                Admins and managers sign in at the <strong>admin portal</strong>. Setters and closers use
                                the <strong>agent portal</strong> with their username.
                            </p>
                            ...
                            <form method="POST"
                                ...
                                <div class="um-form-grid">
                                    <div class="um-field">
                                        ...
                                        <input id="create-username" type="text" name="username" required
                                            placeholder="e.g. setter_ag_k8z" value="{{ old('username') }}"
                                            class="um-input" autocomplete="off">
                                    </div>
                                    <div class="um-field">
                                        <label class="um-label" for="create-role">Role</label>
                                        <select id="create-role" name="role" class="um-input um-select"
                                            data-create-member-role>
                                    ...
                                    <div class="um-field">
                                        ...
                                        <input id="create-password" type="password" name="password" required
                                            minlength="6" placeholder="Min. 6 characters" class="um-input"
                                            autocomplete="new-password">
                                    </div>
                                    <div class="um-field">
                                        <label class="um-label" for="create-password-confirm">Confirm password</label>
                                        <input id="create-password-confirm" type="password" name="password_confirmation"
                                            required minlength="6" placeholder="Repeat password" class="um-input"
                                            autocomplete="new-password">
                                    </div>
                                </div>
