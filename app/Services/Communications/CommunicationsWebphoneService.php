...
class CommunicationsWebphoneService
{
    ...
    public function configFor(User $user, Workspace $workspace, string $extensionNum, string $routePrefix): ?array
    {
        ...
        return [
            ...
            'dial_mode' => (string) config('integrations.morpheus.webphone_dial_mode', 'sip'),
            'auto_answer_click_to_call' => (bool) config('integrations.morpheus.webphone_auto_answer', false),
