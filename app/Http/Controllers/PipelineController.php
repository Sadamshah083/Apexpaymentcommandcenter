...
class PipelineController extends Controller
{
    ...
    public function setterTeamDashboard(Request $request)
    {
        ...
        return view('pipeline.setter-team.index', compact('workspace', 'leads', 'user', 'teamMetrics', 'setters', 'unassignedLeads'));
    }
    ...
    public function closerTeamDashboard(Request $request)
    {
        ...
        return view('pipeline.closer-team.index', compact('workspace', 'leads', 'user', 'teamMetrics', 'closers'));
    }
